...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="space-y-1">
      {label && (
        <label htmlFor={inputId} className="block text-sm font-medium text-gray-700 hebrew-text">
          {label}
        </label>
      )}
      <input
...
export const Select: React.FC<SelectProps> = ({
  ...
  return (
    <div className="space-y-1">
      {label && (
        <label htmlFor={selectId} className="block text-sm font-medium text-gray-700 hebrew-text">
          {label}
        </label>
      )}
      <select
